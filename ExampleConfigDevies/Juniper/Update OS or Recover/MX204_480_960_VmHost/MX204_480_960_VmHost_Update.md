...
```html
request vmhost software add no-validate /var/tmp/***-21.4R3-S5.4.tgz
...
# Create a snapshot on both RE

```html
> request vmhost snapshot routing-engine both no-confirm 
re0:
--------------------------------------------------------------------------
...
```
```html
> show vmhost snapshot routing-engine both 
re0:
--------------------------------------------------------------------------
UEFI    Version: REH_P_MTR1_00.30.07

Secondary Disk, Snapshot Time: Fri Mar  6 09:14:01 UTC 2026

Version: set p
VMHost Version: 5.2386
VMHost Root: vmhost-x86_64-21.2R2-S2-20220201_2230_builder
VMHost Core: vmhost-core-x86-64-21.2R2-S2.3
kernel: 4.8.28-rt10-WR9.0.0.24_ovp
Junos Disk: junos-install-mx-x86-64-21.2R2-S2.3

Version: set b
VMHost Version: 7.2959
VMHost Root: vmhost-x86_64-23.4R2-S5-20250515_2123_builder
VMHost Core: vmhost-core-x86-64-23.4R2-S7.4
kernel: 5.2.60-rt15-LTS19
Junos Disk: junos-install-mx-x86-64-23.4R2-S7.4

re1:
--------------------------------------------------------------------------
UEFI    Version: REH_P_MTR1_00.30.07

Secondary Disk, Snapshot Time: Fri Mar  6 09:15:25 UTC 2026
