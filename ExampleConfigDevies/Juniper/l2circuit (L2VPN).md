...
```html
neighbor <ip_address_neighboor> {                                                                                       ### Neighbor ID
    interface xe-1/3/0.100 {                                                                                            ### Interface name
        virtual-circuit-id <virtual-circuit-id>;                                                                                           ### Identifier for this Layer 2 circuit (1..4294967295)
...
set protocols l2circuit neighbor <ip_address_neighboor> interface xe-1/3/0.100 virtual-circuit-id <virtual-circuit-id>
set protocols l2circuit neighbor <ip_address_neighboor> interface xe-1/3/0.100 description "test_l2circuit"
```
# Troubleshooting
```html
